...
export default function Result() {
  ...
  const standings = [...result.players].sort((a, b) => {
    ...
    <main className="mx-auto flex min-h-screen max-w-7xl items-center px-4 py-8">
      <div className="w-full">
        ...
        <section className="mt-6 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <StatCard label="Total Turn" value={wordsUsed.length} tone="cyan" />
        ...
        <section className="mt-6 grid gap-6 lg:grid-cols-[1fr_0.82fr]">
          ...
          <div className="panel rounded-2xl p-5">
            ...
            <div className="mt-5 flex max-h-[360px] flex-wrap gap-2 overflow-y-auto pr-1">
              {wordsUsed.length === 0 && (
